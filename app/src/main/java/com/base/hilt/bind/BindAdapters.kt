...
import com.base.hilt.ui.home.repository.Vendor
...
class BindAdapters {
    companion object {
        ...
        @BindingAdapter("lostFocusCheck")
        @JvmStatic
        fun TextInputEditText.lostFocusValid(check:String){
            check.let {
                this.onFocusChangeListener = OnFocusChangeListener { p0, p1 ->
                    if (!p1){
                        Log.i("madgg1", "checkValid:1 ${check}")
                    }
                }
            }
        }
