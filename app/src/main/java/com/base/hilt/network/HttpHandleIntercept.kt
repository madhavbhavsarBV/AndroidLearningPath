...
class HttpHandleIntercept(val myPreference: MyPreference) : Interceptor {
...
//        builder.add("Accept-Encoding", "gzip, deflate, br")
        ...
        if (myPreference.getValueBoolean(PrefKey.IS_LOGIN, false)) {
            Log.i("madhome", "observeDataf: ${ HttpCommonMethod.getAuthToken()}")
            ...
            builder.add("Authorization",HttpCommonMethod.getAuthToken())
        }
